...
class ServiciosSuministrosEstrategicos extends CI_Controller {
    ...
    {  
        ...
        $data['list'] = $this->comun_model->ObtenerRegistrosDesdeFuncion('planificacion.fn_select_plan_diario_suministros_estrategicos', "'".$data['date']."'", 14, 14, 1, 1, 'null');		
        $this->load->view('amsa/servicios_suministros_estrategicos/index.php', $data);
    }

    public function export()
    {
        $date = $this->input->get('fecha');
        $list = $this->comun_model->ObtenerRegistrosDesdeFuncion('planificacion.fn_select_plan_diario_suministros_estrategicos', "'".$date."'", 14, 14, 1, 1, 'null');		
        ...
        $sheet->setCellValue('F1', 'Servicios Suministros Estrategicos');
