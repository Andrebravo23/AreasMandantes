            ...
            <div class="widget-box" id="widget-box-6">
                <div class="widget-header widget-header-small center">
                    <h5 class="widget-title smaller">
                        Reporte "Planificación Diaria Servicios Generales y Especiales"
                    </h5>
                </div>
                <div class="panel-body toggle-heading">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="<?= base_url('servicios-formularios');?>" method="POST" style="display: flex; align-items: center">
                                <div class="col-xs-2">
